...
const OpenRatesContact = (props: ContactProp) => {
  const {
    closeModal,
    isOpen,
    booking_data,
  ...
  const onSubmit = (data: any) => {
    const _data = {
      ...
      email: data.email,
      contact_number: data?.phone_number?.phone,
      reason_for_callback: "No Ocean Freight Rate Found From Landing Page",
      best_time_to_call: data.call_time,
      message_body: data.message,
      shipment_id: id,
    };
    console.log("ksl>>", data)
...
export default connect(mapStateToProps, { requestCallBack })(OpenRatesContact);
