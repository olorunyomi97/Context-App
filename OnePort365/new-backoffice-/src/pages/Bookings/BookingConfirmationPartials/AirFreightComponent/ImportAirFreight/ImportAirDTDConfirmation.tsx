...
function ImportAirDTDConfirmation(props: any) {
    ...
    const onSubmit = (data: any) => {
        ...
        const newData = {
            ...
            sender_phone: data?.sender_phone?.phone ? data?.sender_phone?.phone : data?.sender_phone,
                ...
                <div className="grid grid-cols-2">
                    <div className="mr-1">
                        ...
                        <CustomInput
                            ...
                            errors={errors}
                            isDisabled={false}
                            defaultValue={single_booking?.air_freight?.sender_name}
                            min={""}
                            max={""}
                            icon={""}
                        />
                    ...
                    <div className="mr-1">
                        ...
                        {
                            single_booking?.air_freight?.sender_phone === undefined ? (
                                <>
                                    <CustomPhoneInput
                                        control={control}
                                        name={"sender_phone"}
                                ...
                                <>
                                    <CustomInput
                                        ...
                                        errors={errors}
                                        isDisabled={false}
                                        defaultValue={single_booking?.air_freight?.sender_phone}
                                        min={""}
                                        max={""}
                                        icon={""}
                                    />
...
// export default ImportAirDTDConfirmation

const mapStateToProps = (state: any) => {
    const { single_booking, loading } = state.bookings;
    return { single_booking, loading };
};
export default connect(mapStateToProps, { getSingleBooking, editBookingDetails })(ImportAirDTDConfirmation);
