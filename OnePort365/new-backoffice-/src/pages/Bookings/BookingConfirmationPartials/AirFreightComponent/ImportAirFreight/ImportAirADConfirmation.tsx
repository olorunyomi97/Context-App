...
function ImportAirADConfirmation(props: any) {
...
// export default ImportAirADConfirmation

const mapStateToProps = (state: any) => {
    const { single_booking, loading } = state.bookings;
    return { single_booking, loading };
};
export default connect(mapStateToProps, { getSingleBooking, editBookingDetails })(ImportAirADConfirmation);
