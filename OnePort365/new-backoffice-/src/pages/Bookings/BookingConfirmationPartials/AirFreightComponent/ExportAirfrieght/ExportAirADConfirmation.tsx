...
function ExportAirADConfirmation(props: any) {
    const params = useParams();
    const { loading, shipmentType, single_booking } = props;
    const single_booking_details = single_booking?.booking_details
    console.log('Container Count Bug', single_booking_details?.air_cargo_details[0]?.container_count)
        ...
        <div>
            <form onSubmit={handleSubmit(onSubmit)} className="my-5">
                <div className="lg:px-8 px-5">
                    <p className='add-shipment-text mb-5'>Export Shipment & Air Freight(Airport Delivery)</p>
                    ...
                    <div className="mt-3 grid grid-cols-4">
                        ...
                        <div className="m-1 mt-1">
                            <p className="text-xs black-text font-medium"> Airport Drop off date</p>
                            <CustomInput
                                control={control}
...
// export default ExportAirADConfirmation

const mapStateToProps = (state: any) => {
    const { single_booking, loading } = state.bookings;
    return { single_booking, loading };
};
export default connect(mapStateToProps, { getSingleBooking, editBookingDetails })(ExportAirADConfirmation);
