        ...
        <div className="mt-4">
            {
				...
				(
                    ...
                    {
                        contacts?.data?.data?.status === "closed" ? (
                            <> 
								<div className="mt-5 flex flex-col item-center justify-center solid-br rounded mobile-dashboar" style={{ minHeight: 500 }}>
                                    ...
                                    <div className="mx-auto my-2"style={{textAlign:'center'}}>
                                        <p className="grey-text my-3">You have no left messages to attend to yet</p>
                                    </div>
                                </div>
							</>
                        ) : (
...
export default connect(mapStateToProps, {getContacts, updateStatus})(LeaveMessage);
