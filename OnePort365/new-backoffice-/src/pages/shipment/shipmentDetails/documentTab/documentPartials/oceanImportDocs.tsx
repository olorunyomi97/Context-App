...
const OceanImportDocs = (props: any) => {
...
// export default OceanImportDocs 

const mapStateToProps = (state: any) => {
    const { loading } = state.shipments;
    return { loading };
};
export default connect(mapStateToProps, { getSingleShipment, uploadShipmentDocs })(OceanImportDocs);
