...
const ExportHaulageDocs = (props: any) => {
    ...
    //     };
    //     console.log(newData);
    //     // modifyFormDatasheet(newData, null)
    // }
                            ...
                            <div className="mb-3">
                                ...
                                <div className="mt-1">
                                    <CustomDocsDnD
                                        ...
                                        id={"nxp_document"}
                                        pdfOnly={false}
                                        // defaultValue={single_shipment_data?.document_details[0]?.document_name === 'nxp_document' ? single_shipment_data?.document_details?.slice(-1)[0]?.original_file_name : ''}
                                        // defaultValue={single_shipment_data?.document_details?.document_name === 'nxp_document' ? 'nxp_document' : ''}
...
// export default ExportHaulageDocs 
const mapStateToProps = (state: any) => {
    const { loading } = state.shipments;
    return { loading };
};
export default connect(mapStateToProps, { getSingleShipment, uploadShipmentDocs })(ExportHaulageDocs);
