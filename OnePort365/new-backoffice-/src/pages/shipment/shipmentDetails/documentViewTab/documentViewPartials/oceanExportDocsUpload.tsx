...
const oceanExportDocsUpload = (props: any) => {
    ...
    // @ts-ignore
    // const withoutDuplicates = [...new Set(uploadDocDataReversed)]
    // console.log(withoutDuplicates)
    // console.log(uploadDocData)
    // console.log(uploadDocDataReversed)
    // const DuplicateDocs = uploadDocDataReversed => uploadDocDataReversed.filter((item, index) => uploadDocDataReversed.indexOf(item.document_name) !== index)
    // const duplicateUploadedDocuments = DuplicateDocs(uploadDocDataReversed);
    // console.log(duplicateUploadedDocuments)


    // const toFindDuplicateDocs = (DocsArray) => {
    //     const uniqueDocs = new Set(DocsArray);
    //     const filteredDocs = DocsArray.filter(item => {
    //         if (uniqueDocs.has(item)) {
    //             uniqueDocs.delete(item);
    //         } else {
    //             return item
    //         }
    ...
    //     });
    //     // @ts-ignore
    //     return [...new Set(uniqueDocs)]
    // }

    // const DocsArray = [...uploadDocData].reverse();
    // const DuplicateDocs = toFindDuplicateDocs(DocsArray)
    // console.log(DuplicateDocs)
...
export default oceanExportDocsUpload