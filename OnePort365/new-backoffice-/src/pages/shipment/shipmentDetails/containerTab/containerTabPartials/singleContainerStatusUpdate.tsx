...
const SingleContainerStatusUpdate = (props: any) => {
    const params = useParams();
    const { isOpen, setIsOpen, container_id, single_shipment, row_number, loading } = props;
    ...
    // console.log('single-shipment', single_shipment?.data?.data)
...
export default connect(mapStateToProps, { getSingleShipment, editContainerStatus })(SingleContainerStatusUpdate);
