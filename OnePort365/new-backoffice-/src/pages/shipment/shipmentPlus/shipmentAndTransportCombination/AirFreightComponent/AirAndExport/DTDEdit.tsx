                                ...
                                <div className="lg:px-14 lg:pb-5 lg:pt-5 grid grid-cols-2 gap-4 px-5">
                                    ...
                                    <div className="mt-2 ml-auto" style={{ textAlign: "right" }}>
                                        ...
                                        <small style={{ color: "grey" }}>
                                            {" "}
                                            / Edit Export Shipment & Air Freight
                                        </small>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="my-5">
                                    <div className="lg:px-8 px-5">
                                        <p className="add-shipment-text mb-5">
                                            Export Shipment & Air Freight (Door To Door)
                                        </p>
                                            ...
                                            <div className="grid grid-cols-2 mb-2">
                                                ...
                                                <div className="mr-1">
                                                    ...
                                                    <CustomInput
                                                        ...
                                                        errors={errors}
                                                        isDisabled={false}
                                                        defaultValue={single_shipment_data?.consignee_phone}
                                                        min={""}
                                                        max={""}
                                                        icon={""}
                                                    />
...
// export default DTDEdit

const mapStateToProps = (state: any) => {
    const { single_shipment, error, loading } = state.shipments;
    return { single_shipment, error, loading };
};
export default connect(mapStateToProps, { getSingleShipment, editAirShipmentDetails, })(DTDEdit);
