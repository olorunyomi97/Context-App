...
function DTDExportAirFreightForm(props: any) {
    ...
    const onSubmit = (data: any) => {
        ...
        const newData = {
            ...
            consignee_phone: data?.consignee_phone?.phone,
        };
...
// export default DTDExportAirFreightForm

const mapStateToProps = (state: any) => {
    const { error, loading } = state.shipmentsPlus;
    return { error, loading };
};
export default connect(mapStateToProps, { createShipment })(DTDExportAirFreightForm);
