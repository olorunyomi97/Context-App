...
function ADExportAirFreightForm(props: any) {
...
// export default ADExportAirFreightForm

const mapStateToProps = (state: any) => {
    const { error, loading } = state.shipmentsPlus;
    return { error, loading };
};
export default connect(mapStateToProps, { createShipment })(ADExportAirFreightForm);
