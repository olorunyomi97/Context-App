...
function Edit(props: any) {
  ...
  console.log("shipment", single_shipment?.data?.data);
  console.log("shipment of warehousing", single_shipment_data);
                ...
                <div className="lg:px-14 lg:pb-5 lg:pt-5 grid grid-cols-2 gap-4 px-5">
                  ...
                  <div className="mt-2 ml-auto" style={{ textAlign: "right" }}>
                    ...
                    <small style={{ color: "grey" }}>
                      {" "}
                      / Edit Export Shipment & Warehousing
                    </small>
                  </div>
                </div>
              </div>
                    ...
                    <div className="mt-3 grid grid-cols-1 items-center ">
                      ...
                      <div className="mr-1">
                        ...
                        <CustomInput
                          ...
                          errors={errors}
                          isDisabled={true}
                          defaultValue={single_shipment_data?.port_of_loading}
                          min={""}
                          max={""}
                          icon=""
                        />
