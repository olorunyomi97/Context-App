const projects = [
  {
    ...
    files: [
      { name: "Oneport365 Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Oneport365 Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Oneport365 Logo.Zip", size: "2.02 MB", link: "#" },
