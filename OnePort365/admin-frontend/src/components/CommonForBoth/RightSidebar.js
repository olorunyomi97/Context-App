              ...
              <div className="p-4">
                ...
                <div className="radio-toolbar">
                  ...
                  <input
                    ...
                    checked={
                      this.state.layoutWidth === layoutWidthTypes.SCROLLABLE
                    }
                    onChange={this.changeLayoutWidth}
                  />
                  ...
                  {this.state.layoutType === "vertical" ? null : (
                    <>
                      ...
                      <input
                        ...
                        checked={
                          this.state.topbarTheme === topBarThemeTypes.COLORED
                        }
                        onChange={this.changeTopbarTheme}
                      />
                  ...
                  <React.Fragment>
                    ...
                    <div className="radio-toolbar">
                      ...
                      <input
                        ...
                        checked={
                          this.state.sidebarType === leftSidebarTypes.COMPACT
                        }
                        onChange={this.changeLeftSidebarType}
                      />
                      ...
                      <input
                        ...
                        checked={
                          this.state.sidebarType === leftSidebarTypes.ICON
                        }
                        onChange={this.changeLeftSidebarType}
                      />
                ...
                <div className="mb-2">
                  <Link
                    to="//Oneport365-v-light.react.themesbrand.com"
                    target="_blank"
                  >
                    <img
                      src={layout4}
                ...
                <div className="mb-2">
                  <Link
                    to="//Oneport365-v-dark.react.themesbrand.com"
                    target="_blank"
                  >
                    <img
                      src={layout5}
                ...
                <div className="mb-2">
                  <Link
                    to="//Oneport365-v-rtl.react.themesbrand.com"
                    target="_blank"
                  >
                    <img
                      src={layout6}
                ...
                <Link
                  to="//1.envato.market/Oneport365react"
